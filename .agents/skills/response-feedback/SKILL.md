...
metadata:
  ...
  pattern: Response Feedback
  source: uxpatterns.dev
  url: https://uxpatterns.dev/patterns/ai-intelligence/response-feedback
  sourcePath: apps/app/content/patterns/ai-intelligence/response-feedback.mdx
---
...
- https://uxpatterns.dev/patterns/ai-intelligence/ai-error-states
...
Pattern page: https://uxpatterns.dev/patterns/ai-intelligence/response-feedback
