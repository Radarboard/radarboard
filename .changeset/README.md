...
- Desktop releases are opt-in. Add `release-notes/desktop-next.md` when you want the next `Version Packages` PR to cut a desktop release.
- `pnpm release:desktop` scaffolds `release-notes/desktop-next.md` from the repo template.
