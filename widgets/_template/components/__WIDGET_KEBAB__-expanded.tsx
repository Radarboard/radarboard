/**
 * __WIDGET_NAME__ — Expanded fullscreen view
 *
 * Template-backed by default. Add expandedRecipe in index.ts if the expanded
 * layout should differ from compact.
 */

import { TemplateWidgetExpanded, type WidgetTemplateConfig } from "@radarboard/widget-engine/templates";
import type { WidgetRenderProps } from "@radarboard/widget-sdk/widget-types";

export function __WIDGET_PASCAL__Expanded({
  widgetId,
  projectSlug,
  timeRange,
  config,
