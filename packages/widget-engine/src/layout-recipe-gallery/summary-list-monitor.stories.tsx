...
const recipe = LAYOUT_RECIPES.find((item) => item.id === "summary-list-monitor");
if (!recipe) throw new Error("Missing layout recipe: summary-list-monitor");

const meta = preview.meta({
  title: "Layout Recipes/Summary + List",
