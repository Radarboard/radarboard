...
const recipe = LAYOUT_RECIPES.find((item) => item.id === "summary-band");
if (!recipe) throw new Error("Missing layout recipe: summary-band");

const meta = preview.meta({
  title: "Layout Recipes/Summary Band",
