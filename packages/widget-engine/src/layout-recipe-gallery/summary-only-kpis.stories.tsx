...
const recipe = LAYOUT_RECIPES.find((item) => item.id === "summary-only-kpis");
if (!recipe) throw new Error("Missing layout recipe: summary-only-kpis");

const meta = preview.meta({
  title: "Layout Recipes/Summary Only",
