...
const recipe = LAYOUT_RECIPES.find((item) => item.id === "card-grid-library");
if (!recipe) throw new Error("Missing layout recipe: card-grid-library");

const meta = preview.meta({
  title: "Layout Recipes/Card Grid Library",
