...
const recipe = LAYOUT_RECIPES.find((item) => item.id === "rail-workbench");
if (!recipe) throw new Error("Missing layout recipe: rail-workbench");

const meta = preview.meta({
  title: "Layout Recipes/Rail Workbench",
