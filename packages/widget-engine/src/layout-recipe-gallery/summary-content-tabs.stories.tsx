...
const recipe = LAYOUT_RECIPES.find((item) => item.id === "summary-content-tabs");
if (!recipe) throw new Error("Missing layout recipe: summary-content-tabs");

const meta = preview.meta({
  title: "Layout Recipes/Summary + Tabs",
