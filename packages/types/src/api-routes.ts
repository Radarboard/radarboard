...
export const API_ROUTE_PATTERNS = {
  ...
  authProviderBrokerCallback: defineApiRoutePattern("/api/auth/:provider/broker-callback"),
  authProviderBrokerHostedCallback: defineApiRoutePattern("/api/auth/broker/:provider/callback"),
  authProviderBrokerRedeem: defineApiRoutePattern("/api/auth/broker/:provider/redeem"),
  authProviderBrokerAccessToken: defineApiRoutePattern("/api/auth/broker/:provider/access-token"),
