...
- 520b374: Improve dashboard hook stability and test coverage around fallback and loading behavior.
- 520b374: Add demo mode support to useNotifications — returns mock notifications and disables mutations when demoMode is active.
