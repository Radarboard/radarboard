...
<Steps>
  ...
  <Step title="When ready, publish">
    Push your extension repo to GitHub and install via the GitHub URL in Settings → Extensions. For shared extensions, open a pull request in [`Radarboard/community-extensions`](https://github.com/Radarboard/community-extensions).
  </Step>
</Steps>
