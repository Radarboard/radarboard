...
Size of the expanded widget overlay: "sm", "content", "md", or "lg".

```ts
type WidgetModalSize = "sm" | "content" | "md" | "lg"
```
...
| `expandedSize?` | `ModalSize \| undefined` | Optional size override for the expanded overlay. Omit this to use the centralized widget default size ("md"). Available sizes: "sm", "content", "md", and "lg". |
