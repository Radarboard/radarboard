...
- Keep `Release Activity` as the user-facing name for the release timeline widget. Use `Shipping Log` only for legacy links or explanatory copy that refers to the old feed/timeline name.
