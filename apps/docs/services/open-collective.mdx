...
- **Sponsorship widget** -- Full Open Collective view with KPIs, transactions, and members
...
<CardGroup cols={2}>
  ...
  <Card title="Sponsorship" icon="heart-handshake" href="/widgets/sponsorship">
    Full Open Collective KPIs, transactions, and members layout.
  </Card>
</CardGroup>
