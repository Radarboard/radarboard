---
title: "Linear"
description: "Fetch open issues (ideas and bugs) and completed issues for Release Activity."
---

# Linear

Linear integration provides project management data: open issues categorized as ideas or bugs (based on label names), and recently completed issues for Release Activity.

## What it powers

- **Ideas + Bugs widget** -- List of open issues with priority, status, and age
- **Release Activity widget** -- Completed issues appear as release items
...
<CardGroup cols={2}>
  ...
  <Card title="Release Activity" icon="ship" href="/widgets/shipping">
    Shows completed Linear issues as release items.
  </Card>
</CardGroup>
