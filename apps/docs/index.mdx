...
- **Release Activity** via GitHub, Linear, and Vercel (merged PRs, completed issues, deploys)
...
<CardGroup cols={2}>
  <Card title="20+ Widgets" icon="grid-2">
    Revenue, Release Activity, Ideas + Bugs, Analytics, SEO Performance, and Detail Panel -- all configurable and expandable.
  </Card>
