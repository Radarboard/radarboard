...
description: "A scrollable feed of recent release activity: merged PRs, completed issues, and production deploys."
---

# Release Activity Widget

The Release Activity widget shows a chronological feed of release work across GitHub, Linear, and Vercel.
...
Release Activity uses the shared feed/list primitives and shared detail host rather than a bespoke widget renderer.
...
<Note>
  If none of the three services are configured, Release Activity will show an empty state.
</Note>
