...
const meta = {
  title: "Components/Settings/Settings Integrations/Access/ProviderConnectionManagerCard",
...
export const Default = {
  render: () =>
    renderScaffoldStory({
      ...
      sourcePath: "apps/app/components/settings/settings-integrations/components/access/connection-manager.tsx",
      Component: ProviderConnectionManagerCard,
      args: {},
    }),
};
