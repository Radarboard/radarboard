...
const meta = {
  title: "Components/Settings/Settings Integrations/IntegrationNotificationsCard",
...
export const Default = {
  render: () =>
    renderScaffoldStory({
      ...
      sourcePath:
        "apps/app/components/settings/settings-integrations/components/channels/notification-card.tsx",
      Component: IntegrationNotificationsCard,
      args: {},
    }),
};
