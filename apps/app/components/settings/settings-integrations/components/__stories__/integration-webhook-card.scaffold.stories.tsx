...
const meta = {
  title: "Components/Settings/Settings Integrations/IntegrationWebhookCard",
...
export const Default = {
  render: () =>
    renderScaffoldStory({
      ...
      sourcePath:
        "apps/app/components/settings/settings-integrations/components/channels/webhook-card.tsx",
      Component: IntegrationWebhookCard,
      args: {},
    }),
};
